...
//            //await LoadData();
//            User = user;
//            DataSource = kPITaskDtos.Where(x => x.FactoryId == user.FactoryId
//            && x.DepartmentId == user.DepartmentId).ToList();
...
//        {
//            var result = await Http.GetFromJsonAsync<List<UserTaskDto>>($"api/UserTask/list-taskIds/{User.Id}");
...
//            {
//               await CulatedTarget(CreatedTarget)
//                activeTabKey = "3";
//                TitleButton = "Back ⟵";
//            }
