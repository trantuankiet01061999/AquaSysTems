...
{
    public partial class ScrapManagement
    {
        ...
        private List<HistoryScrapDto> ListHistory { get; set; } = new List<HistoryScrapDto>();

        private Table<HistoryScrapDto> _tableRef;
        private RegisterScrapModal registerScrapModal;
